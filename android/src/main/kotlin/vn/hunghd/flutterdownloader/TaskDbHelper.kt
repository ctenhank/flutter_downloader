...
class TaskDbHelper private constructor(context: Context) :
    ...
    private fun update3to4(db: SQLiteDatabase, oldVersion: Int) {
        ...
        db.execSQL(
                "ALTER TABLE ${TaskEntry.TABLE_NAME} ADD COLUMN ${TaskEntry.COLUMN_ALLOW_CELLULAR} TINYINT DEFAULT 1"
        )
    }
    ...
    private fun update4to5(db: SQLiteDatabase, oldVersion: Int) {
        ...
        db.execSQL(
                "ALTER TABLE ${TaskEntry.COLUMN_NAME_TIME_LAST_UPDATED} ADD COLUMN ${TaskEntry.COLUMN_NAME_TIME_LAST_UPDATED} TINYINT DEFAULT 0"
        )
    }
