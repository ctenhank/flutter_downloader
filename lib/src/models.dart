...
class DownloadTask {
  ...
  @override
  String toString() =>
      'DownloadTask(taskId: $taskId, status: $status, progress: $progress, url: $url, filename: $filename, savedDir: $savedDir, timeCreated: $timeCreated, timeLastUpdated: $timeLastUpdated, allowCellular: $allowCellular)';
